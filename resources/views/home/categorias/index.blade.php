    ...
    <div class="container mt-5">
        ...
        <div class="row">
            ...
            <div class="col-md-4 text-end">
                <form action="{{ route('home.categorias.index') }}" method="GET" class="row">
                        ...
                        <tr>
                            ...
                            <td>
                                <button class="btn btn-sm btn-primary"
                                    onclick="abrirModal('{{ $categoria->id_categoria }}', '{{ $categoria->descripcion }}')">
                                    <i class='bx bxs-pencil'></i>
                                </button>
                                <form id="form-eliminar-{{ $categoria->id_categoria }}"
                                    action="{{ route('home.categorias.destroy', $categoria->id_categoria) }}" method="POST"
                                    class="d-inline">
                                    @csrf
                                    @method('DELETE')
            ...
            <form id="formCategoria" method="POST" action="{{ route('home.categorias.store') }}">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div id="error-descripcion" class="text-danger mt-1" style="display: none;">El campo descripción es
                            obligatorio.</div>
