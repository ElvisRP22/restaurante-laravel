                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="row mb-2">
                            ...
                            <div class="col-md-12">
                                <input id="clave" type="password" class="form-control @error('clave') is-invalid @enderror" name="clave" required>
                                @error('clave')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="row mb-2">
                            ...
                            <div class="col-md-12">
                                <input id="clave_confirmation" type="password" class="form-control" name="clave_confirmation" required>
                            </div>
                        </div>
                        ...
                        <div class="row mb-2">
                            ...
                            <div class="col-md-12">
                                <input id="fecha_ingreso" type="date" class="form-control @error('fecha_ingreso') is-invalid @enderror" name="fecha_ingreso" value="{{ old('fecha_ingreso', now()->format('Y-m-d')) }}" required>
                                @error('fecha_ingreso')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
